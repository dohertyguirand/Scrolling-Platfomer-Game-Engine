...
public class ResizeImageEffect implements NonCollisionEffect {
   ...
   */
  @Override
  public void doEffect(double elapsedTime, Entity subject, Map<String, Double> variables, GameInternal game) {
