...
public class ViewTextEntity implements ViewEntity {
  ...
  public void bindGenericProperties(Entity entity, List<DoubleProperty> cameraShift) {
    ...
    text.layoutXProperty().bind(entity.xProperty().add(entity.stationaryProperty().multiply(cameraShift.get(0))));
    text.layoutYProperty().bind(entity.yProperty().add(new SimpleDoubleProperty(Y_OFFSET)).add(entity.stationaryProperty().multiply(cameraShift.get(1))));
